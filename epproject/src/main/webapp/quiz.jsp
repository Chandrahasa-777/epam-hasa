...
<center><h1 style="color: orange">Quizes Without Time Limit</h1></center>
  <div class="row">
  <div class="column">
    <div class="card" style="color: orange">Quiz1
    <div><a href="quiz2.jsp" class="button">Click here</a></div>
    </div>
  </div>
  <div class="column" style="color: orange">
    <div class="card">Quiz2
    <div><a href="quiz2.jsp" class="button">Click here</a></div>
    </div>
  </div>
  <div class="column" style="color: orange">
    <div class="card">Quiz3
    <div><a href="quiz2.jsp" class="button">Click here</a></div>
    </div>
  </div>
  <div class="column" style="color: orange">
    <div class="card">Quiz4
    <div><a href="quiz2.jsp" class="button">Click here</a></div>
    </div>
  </div>
 <div>
 ...
 <div><center><h1 style="color: orange">Quizes With Time Limit</h1></center></div>
  ...
  <div class="row" >
   <div class="column" style="padding-top:20px">
    <div class="card" style="color: orange">Quiz5
    <div><a href="quiz3.jsp" class="button">Click here</a></div>
    </div>
  </div>
  <div class="column" style="padding-top:20px">
    <div class="card" style="color: orange">Quiz6
    <div><a href="quiz3.jsp" class="button">Click here</a></div>
    </div>
  </div>
  <div class="column" style="padding-top:20px">
    <div class="card" style="color: orange">Quiz7
    <div><a href="quiz3.jsp" class="button">Click here</a></div>
    </div>
  </div>
  <div class="column" style="padding-top:20px">
    <div class="card" style="color: orange">Quiz8
    <div><a href="quiz3.jsp" class="button">Click here</a></div>
    </div>
  </div>
 </div>
