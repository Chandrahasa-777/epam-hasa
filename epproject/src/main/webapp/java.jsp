 ...
 <div><center><h1 style="color: orange">Quizes With Time Limit</h1></center></div>
  ...
  <div class="row" >
   <div class="column" style="padding-top:20px">
    <div class="card" style="color: orange">Getters and Setters
  ...
  <div class="column" style="padding-top:20px">
    <div class="card" style="color: orange">File Handling
    <div><a href="quiz3.jsp" class="button">Click here</a></div>
    </div>
  </div>
  <div class="column" style="padding-top:20px">
    <div class="card" style="color: orange">References
    <div><a href="quiz3.jsp" class="button">Click here</a></div>
    </div>
  </div>
 </div>
