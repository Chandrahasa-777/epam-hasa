...
<center><h1 style="color: orange">Quizes Without Time Limit</h1></center>
  <div class="row">
  <div class="column">
    <div class="card" style="color: orange">Basics
  ...
  <div class="column" style="color: orange">
    <div class="card">Storage Classes
    <div><a href="quiz2.jsp" class="button">Click here</a></div>
    </div>
  </div>
  <div class="column" style="color: orange">
 ...
 <div><center><h1 style="color: orange">Quizes With Time Limit</h1></center></div>
  ...
  <div class="row" >
   <div class="column" style="padding-top:20px">
    <div class="card" style="color: orange">Arrays & Strings
    <div><a href="quiz3.jsp" class="button">Click here</a></div>
    </div>
  </div>
  <div class="column" style="padding-top:20px">
    <div class="card" style="color: orange">Memory Allocation
    <div><a href="quiz3.jsp" class="button">Click here</a></div>
    </div>
  </div>
  <div class="column" style="padding-top:20px">
    <div class="card" style="color: orange">Pointers
    <div><a href="quiz3.jsp" class="button">Click here</a></div>
    </div>
  </div>
  <div class="column" style="padding-top:20px">
    <div class="card" style="color: orange">Arrays
    <div><a href="quiz3.jsp" class="button">Click here</a></div>
    </div>
  </div>
 </div>
