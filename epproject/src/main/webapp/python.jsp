...
<center><h1 style="color: orange">Quizes Without Time Limit</h1></center>
  <div class="row">
  <div class="column">
    <div class="card" style="color: orange">Introduction to python
    <div><a href="quiz2.jsp" class="button">Click here</a></div>
    </div>
  </div>
  <div class="column" style="color: orange">
    <div class="card">Strings
    <div><a href="quiz2.jsp" class="button">Click here</a></div>
    </div>
  </div>
  <div class="column" style="color: orange">
    <div class="card">Lists & Tuples
    <div><a href="quiz2.jsp" class="button">Click here</a></div>
    </div>
  </div>
  <div class="column" style="color: orange">
    <div class="card">Dictonaries & Sets
    <div><a href="quiz2.jsp" class="button">Click here</a></div>
    </div>
  </div>
 <div>
 ...
 <div><center><h1 style="color: orange">Quizes With Time Limit</h1></center></div>
  ...
  <div class="row" >
   <div class="column" style="padding-top:20px">
    <div class="card" style="color: orange">Loops
    <div><a href="quiz3.jsp" class="button">Click here</a></div>
    </div>
  </div>
  <div class="column" style="padding-top:20px">
    <div class="card" style="color: orange">Comprensions
    <div><a href="quiz3.jsp" class="button">Click here</a></div>
    </div>
  </div>
  <div class="column" style="padding-top:20px">
  ...
  <div class="column" style="padding-top:20px">
    <div class="card" style="color: orange">Modules
    <div><a href="quiz3.jsp" class="button">Click here</a></div>
    </div>
  </div>
 </div>
